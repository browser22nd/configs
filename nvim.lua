...
vim.keymap.set("n", "<leader>w", ":w<CR>", { desc = "Next search result (centered)" })
...
vim.pack.add({
	...
	"https://github.com/creativenull/efmls-configs-nvim",
	{
		...
		-- changes vs v1). Staying pinned to v1 here deliberately for stability.h
